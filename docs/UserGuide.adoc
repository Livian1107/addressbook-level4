...
For the current version, students can add their team mates into the app. They can create a new task list through google task. By default, app will display all the link:DeveloperGuide.adoc[<<Learning-Outcomes,Learning Outcomes>>][Learning Outcomes] for this week in the task list.
