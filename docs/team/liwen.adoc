...
* *Minor enhancement*: improve the UI from current version with another new theme

* *Minor enhancement*: add a sort command to display teammates with their name in lexicological order
